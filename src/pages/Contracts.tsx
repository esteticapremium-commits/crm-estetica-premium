...
export default function Contracts() {
  ...
  const [hasProfessionalUpgrade, setHasProfessionalUpgrade] = useState(true);
  ...
  return <div className="page contracts-page">
    ...
    {selected && <ContractDetail contract={selected} events={events.filter((e) => e.contract_id === selected.id)} professionalFeatures={hasProfessionalUpgrade} onClose={() => setSelected(null)} onRenew={renew} onRevoke={revoke} />}
  </div>;
}
